...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        @Test
        public void whenOldAssetExistsAndNewAssetDoesNotExist() {
            AssetTransfer contract = new AssetTransfer();
            Context ctx = mock(Context.class);
            ChaincodeStub stub = mock(ChaincodeStub.class);
            when(ctx.getStub()).thenReturn(stub);
            ...
            Asset asset = contract.DuplicateAsset(ctx, "asset1", "asset2", "Messi");

            assertThat(asset).isEqualTo(new Asset("asset2", "blue", 45, "Messi", 60));
        }

        @Test
        public void whenOldAssetDoesNotExist() {
            AssetTransfer contract = new AssetTransfer();
            Context ctx = mock(Context.class);
            ChaincodeStub stub = mock(ChaincodeStub.class);
            when(ctx.getStub()).thenReturn(stub);
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "asset2", "Messi");
            });
        ...
        @Test
        public void whenNewAssetExists() {
            AssetTransfer contract = new AssetTransfer();
            Context ctx = mock(Context.class);
            ChaincodeStub stub = mock(ChaincodeStub.class);
            when(ctx.getStub()).thenReturn(stub);
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "asset1", "Messi");
            });
